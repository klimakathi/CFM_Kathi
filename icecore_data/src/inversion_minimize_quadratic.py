...
theta_0 = [0.1, 0.42, 75]  # initial guess
...
t = 1. / theta_0[0] ** 2 * d18o_smooth ** 2 + 1. / theta_0[1] * d18o_smooth + theta_0[2]
...
def fun(theta):
    ...
    b = theta[1]
    c = theta[2]
    temperature = 1. / a ** 2 * d18o_smooth ** 2 + 1. / b * d18o_smooth + c
...
def plot_fun(theta0, theta1):
    ...
    temperature0 = 1. / a0 ** 2 * d18o_smooth + 1. / b0 * d18o_smooth + c0
    ...
    temperature1 = 1. / a1 ** 2 * d18o_smooth + 1. / b1 * d18o_smooth + c1
    ...
    if d15n_age == 'ice_age':
        ...
        plt.plot(gasAge_model0, d15N2_model0, label='Barnola first guess: a=%5.3f K, b=%5.3f K, c=%5.3f K' % (
            theta0[0], theta0[1], theta0[2]), linewidth=0.9)
        plt.plot(gasAge_model1, d15N2_model1, label='Barnola first guess: a=%5.3f K, b=%5.3f K, c=%5.3f K' % (
            theta1[0], theta1[1], theta1[2]), linewidth=0.9)
