...
def enthalpyDiff(self, iii):
    ...
    K_ice = 9.828 * np.exp(
        -0.0057 * phi_0)  # thermal conductivity, ice (W/m/K), Cuffey and Paterson, eq. 9.2 (Yen 1981)
    ...
    self.Tz, g_liq = transient_solve_EN(z_edges_vec, z_P_vec, nt, self.dt[iii], Gamma_P, phi_0, nz_P, nz_fv, phi_s,
                                        tot_rho, c_vol, g_liq, deltaH)
